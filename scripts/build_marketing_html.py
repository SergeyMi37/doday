...
def main() -> None:
    posts: dict[str, dict[str, str]] = {
        ...
        "habr-timezones": {
            ...
            "paste_target": "Хабр",
            "source": "docs/articles/2026-09-17-habr-timezones.md",
            "platform_note": (
                "Откройте страницу /raw, скопируйте Markdown целиком и вставьте "
                "его в Markdown-режим редактора Хабра — заголовки и блоки кода "
                "приедут как есть. Картинок в статье нет, нужна только обложка "
                "780×440 в поле «Отображение публикации в ленте»."
            ),
        },
        "vc-bots-ai-seo": {
            "title": "VC.ru: 176 ботов и двенадцать дыр",
            "paste_target": "VC.ru",
            "source": "docs/articles/2026-08-29-vc-bots-ai-seo.md",
            "platform_note": (
                "Редактор VC.ru обрезает заголовки при вставке — это их особенность. "
                "После вставки выделите каждый заголовок из списка ниже и нажмите «H2» "
                "в панели форматирования. Если редактор давится большой вставкой — "
                "копируйте по секциям кнопками ниже. Картинки грузите файлами: "
                "внешние ссылки VC.ru проксирует и иногда теряет."
            ),
        },
        "english-bots-ai-seo": {
